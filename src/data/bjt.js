...
export const bjtLevels = ['J1+', 'J1', 'J2', 'J3', 'J4', 'J5']
...
export const bjtKeigo = [
  ...
  { plain: '知る', sonkei: 'ご存知です / ご存知でいらっしゃる', kenjou: '存じる / 存じ上げる', scene: 'Knowing (internal)' },
  ...
  { plain: '会う', sonkei: 'お会いになる', kenjou: 'お目にかかる', scene: 'Meeting someone' },
  { plain: '受け取る', sonkei: 'お受け取りになる', kenjou: '頂戴する / 拝受する', scene: 'Receiving' },
  { plain: '待つ', sonkei: 'お待ちになる', kenjou: 'お待ちする / お待ちいたす', scene: 'Waiting' },
  { plain: '読む', sonkei: 'お読みになる', kenjou: '拝読する', scene: 'Reading (someone’s writing)' },
  { plain: '考える', sonkei: 'お考えになる', kenjou: '存じる / 拝察する', scene: 'Thinking / considering' },
  { plain: '使う', sonkei: 'お使いになる / お使いくださる', kenjou: 'お使いする / 使わせていただく', scene: 'Using' }
]
...
export const bjtVocab = [
  ...
  { word: '会議', reading: 'かいぎ', meaning: 'Meeting', level: 'J5' },
  ...
  { word: '稟議', reading: 'りんぎ', meaning: 'Internal approval process', level: 'J2' },
  // Real, standalone business vocabulary. (This block previously held ~30
  // artificial 稟議+noun compounds such as 稟議紙 / 稟議フロー that are not used
  // in real Japanese documents.)
  { word: '承認', reading: 'しょうにん', meaning: 'Approval', level: 'J2' },
  { word: '決裁', reading: 'けっさい', meaning: 'Final approval / sign-off', level: 'J1' },
  { word: '審議', reading: 'しんぎ', meaning: 'Deliberation / review', level: 'J1' },
  { word: '可決', reading: 'かけつ', meaning: 'Passed / adopted', level: 'J1' },
  { word: '否決', reading: 'ひけつ', meaning: 'Rejected / voted down', level: 'J1' },
  { word: '保留', reading: 'ほりゅう', meaning: 'On hold / pending', level: 'J2' },
  { word: '起案', reading: 'きあん', meaning: 'Drafting a proposal', level: 'J2' },
  { word: '回覧', reading: 'かいらん', meaning: 'Circulation (of a document)', level: 'J2' },
  { word: '申請', reading: 'しんせい', meaning: 'Application / request', level: 'J3' },
  { word: '提出', reading: 'ていしゅつ', meaning: 'Submission', level: 'J3' },
  { word: '経費', reading: 'けいひ', meaning: 'Expenses', level: 'J2' },
  { word: '精算', reading: 'せいさん', meaning: 'Settlement of accounts / reimbursement', level: 'J2' },
  { word: '見送る', reading: 'みおくる', meaning: 'To postpone / pass on (a plan)', level: 'J1' },
  { word: '打ち合わせ', reading: 'うちあわせ', meaning: 'Meeting / briefing', level: 'J3' },
  { word: '案件', reading: 'あんけん', meaning: 'Matter / deal / project', level: 'J2' },
  { word: '担当', reading: 'たんとう', meaning: 'Person in charge', level: 'J4' },
  { word: '上司', reading: 'じょうし', meaning: 'Superior / boss', level: 'J4' },
  { word: '部署', reading: 'ぶしょ', meaning: 'Department / division', level: 'J3' },
  { word: '残業', reading: 'ざんぎょう', meaning: 'Overtime work', level: 'J4' },
  { word: '有給', reading: 'ゆうきゅう', meaning: 'Paid leave', level: 'J3' },
  { word: '納品', reading: 'のうひん', meaning: 'Delivery of goods', level: 'J3' },
  { word: '発注', reading: 'はっちゅう', meaning: 'Placing an order', level: 'J3' },
  { word: '受注', reading: 'じゅちゅう', meaning: 'Receiving an order', level: 'J2' },
  { word: '値引き', reading: 'ねびき', meaning: 'Discount', level: 'J3' },
  { word: '交渉', reading: 'こうしょう', meaning: 'Negotiation', level: 'J2' },
  { word: '合意', reading: 'ごうい', meaning: 'Agreement / consensus', level: 'J2' },
  { word: '締結', reading: 'ていけつ', meaning: 'Conclusion (of a contract)', level: 'J1' },
  { word: '解約', reading: 'かいやく', meaning: 'Cancellation of a contract', level: 'J2' },
  { word: '苦情', reading: 'くじょう', meaning: 'Complaint', level: 'J2' },
...
export const bjtListening = [
  {
    ...
    questions: [
      {
        prompt: 'お客様は何を尋ねていますか。',
        options: [
          { label: '取引先を変える', correct: false },
          { label: '納期の変更が可能かどうか', correct: true },
...
export const bjtDailyQuestions = [
  ...
  { id: 2, level: 'J3', prompt: 'What does 納期 mean?', options: [{ label: 'Delivery date', correct: true }, { label: 'Payment date', correct: false }, { label: 'Meeting date', correct: false }, { label: 'Hiring date', correct: false }], explanation: '納期 = delivery date.' },
  ...
  { id: 11, level: 'J2', prompt: 'What does 業績 mean?', options: [{ label: 'Business performance', correct: true }, { label: 'Business trip', correct: false }, { label: 'Business card', correct: false }, { label: 'Business lunch', correct: false }], explanation: '業績 = business performance / results.' },
  ...
  { id: 13, level: 'J4', prompt: 'What does 出張 mean?', options: [{ label: 'Business trip', correct: true }, { label: 'Overtime', correct: false }, { label: 'Resignation', correct: false }, { label: 'Promotion', correct: false }], explanation: '出張 = business trip.' },
  { id: 14, level: 'J2', prompt: 'What is 議事録?', options: [{ label: 'Meeting minutes', correct: true }, { label: 'Contract', correct: false }, { label: 'Invoice', correct: false }, { label: 'Schedule', correct: false }], explanation: '議事録 = meeting minutes.' },
  ...
  { id: 16, level: 'J1', prompt: 'Which word means “on hold / pending”?', options: [{ label: '可決', correct: false }, { label: '保留', correct: true }, { label: '決裁', correct: false }, { label: '承認', correct: false }], explanation: '保留 means pending / on hold.' },
  ...
  { id: 20, level: 'J3', prompt: 'What is 退職?', options: [{ label: 'Resignation / retirement', correct: true }, { label: 'Employment', correct: false }, { label: 'Transfer', correct: false }, { label: 'Training', correct: false }], explanation: '退職 = retirement / resignation.' },
  ...
  { id: 25, level: 'J4', prompt: 'What does 訪問 mean?', options: [{ label: 'Visit', correct: true }, { label: 'Move', correct: false }, { label: 'Call', correct: false }, { label: 'Report', correct: false }], explanation: '訪問 = visit.' },
...
export const bjtStrategy = {
  'J1+': 'Near-native business Japanese. Handle board-level discussion, contract nuance, and ambiguous indirect requests at speed.',
